                               ...
                               <p className="bold font-semibold text-3xl ">Get in touch</p>
                                ...
                                <div className="flex flex-col gap-4 sm:gap-6">
                                    <div className="flex items-center mx-auto w-fit gap-4 sm:gap-6 flex-wrap max-w-[600px] text-3xl sm:text-4xl">
                                        <a href="https://www.linkedin.com/in/jamezmcarthur/" target="_blank" className="duration-200 hover:text-blue-400">
                                        ...
                                        <a href="https://youtube.com/smoljames" target="_blank" className="duration-200 hover:text-blue-400">
                                        ...
                                        <a href="https://twitter.com/_Smoljames" target="_blank" className="duration-200 hover:text-blue-400">

                ...
                <div className="flex relative flex-col gap-2 p-6 relative rounded-lg flex-1 bg-black min-w-[180px] min-h-[240px] overflow-hidden shadow-lg shadow-cyan-500 justify-between border border-solid border-white border-3">
                    <div className="hidden sm:flex flex-col gap-4">
                        <div className="flex items-center justify-between gap-2 z-10">
                            <h3 className="text-3xl sm:text-4xl md:text-5xl font-semibold">01 </h3>
                           
                            <div className="flex gap-2 justify-center items-center">
                                <UploadIcon className="w-16 h-16 sm:w-10 sm:h-10 md:w-12 md:h-12" />
                        ...
                        <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold">Upload or Record</h3>
                    </div>
                  
                    <p className=" pbz-10 text-center sm:text-left text-md sm:text-lg md:text-xl py-4">Choose your file of choice to be transcribed by our platform.</p>
                </div>

                {/*Container 2*/}
                <div className="flex relative flex-col gap-2 p-6 relative rounded-lg flex-1 bg-black min-w-[180px] min-h-[240px] overflow-hidden shadow-lg shadow-cyan-500 justify-between border border-solid border-white border-3">                    <div className="hidden sm:flex flex-col gap-4">
                        <div className="flex items-center justify-between gap-2 z-10">
                            <h3 className="text-3xl sm:text-4xl md:text-5xl font-semibold">02 </h3>
                        ...
                        <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold">Select & Edit</h3>
                    </div>

                    <p className=" pbz-10 text-center sm:text-left text-md sm:text-lg md:text-xl py-4">Select a language for transcription and edit for complete accuracy.</p>
                </div>

                {/*Container 3*/}
                <div className="flex relative flex-col gap-2 p-6 relative rounded-lg flex-1 bg-black min-w-[180px] min-h-[240px] overflow-hidden shadow-lg shadow-cyan-500 justify-between border border-solid border-white border-3">                    <div className="hidden sm:flex flex-col gap-4">
                        <div className="flex items-center justify-between gap-2 z-10">
                            <h3 className="text-3xl sm:text-4xl md:text-5xl font-semibold">03 </h3>
                            <div className="text-xl sm:text-2xl md:text-3xl">
                                <div className="flex gap-2">
                                    <DownloadIcon className="w-18 h-18 sm:w-10 sm:h-10 md:w-12 md:h-12" />

                                </div>
                            </div>
                        </div>
                        <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold">Download</h3>
                    </div>

                    <p className=" pbz-10 text-center sm:text-left text-md sm:text-lg md:text-xl py-4">Download your upgraded video with captions or a voice-over.</p>
                </div>

    ...
    return (
        ...
        <section id="about" className="flex flex-col gap-6 lg:gap-10 text-center mt-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 w-full mx-auto mt-6 mb-10">
                ...
                {/*Container 3*/}
                <div className="flex relative flex-col gap-2 p-6 relative rounded-lg flex-1 bg-black fill-white min-w-[180px] min-h-[240px] overflow-hidden shadow-lg shadow-cyan-500 justify-between border border-solid border-white border-3 text-white">
                    <div className="sm:flex flex-col gap-4">
